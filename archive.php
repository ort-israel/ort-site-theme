...
?>
    ...
    <div id="primary" class="content-area">
        ...
        if (property_exists($term, 'slug') && !(in_array('news', $classes))) {
        ...
        // Tsofiya Test Sub-categories
        /*if (in_array('category-videort', $classes) || in_array('category-newsletter', $classes)) {
            $utils->list_categories($term, $term_child);
        }*/
        ?>
            <div class="articles">
                ...
                while (have_posts()) :
                    ...
                    if ($cat_kind && in_array('category-horizontal', $cat_kind) ||
                        property_exists($term, 'slug') && $term->slug == 'correspondence' ||
                        is_tag() ||
                        $term->name == 'cool_timeline') {
